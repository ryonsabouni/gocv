...
// typedef cv::Ptr<cv::SimpleBlobDetector::Params>* SimpleBlobDetectorParams;
#else
typedef void* AKAZE;
...
// typedef void* SimpleBlobDetectorParams;
#endif
...
SimpleBlobDetector SimpleBlobDetector_Create(SimpleBlobDetector_Params params = NULL);
